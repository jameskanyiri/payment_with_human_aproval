...
def get_orders(
    ...
    orders = [
        {"name": "Item 1", "price": 100, "currency": "Ksh", "quantity": 1, "payment_status": "paid"},
        {"name": "Item 2", "price": 200, "currency": "Ksh", "quantity": 2, "payment_status": "pending"},
        {"name": "Item 3", "price": 50, "currency": "Ksh", "quantity": 4, "payment_status": "paid"},
        {"name": "Item 4", "price": 75, "currency": "Ksh", "quantity": 1, "payment_status": "pending"},
        {"name": "Item 5", "price": 100, "currency": "Ksh", "quantity": 1, "payment_status": "failed"},
    ]
